...
globalKeys = gears.table.join(
  ...
  awful.key({ modkey, "Shift"   }, "s", function () awful.util.spawn("ksnip -r", false) end,
    {description = "take a screenshot", group = "launcher"}),
  awful.key({ modkey,           }, "b", function () awful.spawn(apps.browser) end,
    {description = "open a browser", group = "launcher"}),
  awful.key({ modkey,           }, "f", function () awful.spawn(apps.explorer) end,
    {description = "open a file explorer", group = "launcher"}),



  awful.key({}, "XF86AudioRaiseVolume", function () awful.util.spawn("amixer -q set Master 5%+", false) end),
